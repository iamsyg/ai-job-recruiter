...
PROTOTYPES = {
    ...
    "langchain_wrapper_only": [
        "Built chatbots by connecting OpenAI APIs through LangChain without designing retrieval systems.",
        "Created RAG demos using LangChain and Pinecone with mostly default settings and minimal customization.",
        "Integrated hosted LLM APIs into applications but did not build ranking, search, or recommendation systems.",
        "Experience focused on prompt engineering and workflow orchestration rather than ML or IR engineering.",
        "Developed AI assistants using third-party frameworks without implementing embedding pipelines or retrieval algorithms.",
        "Built proof-of-concept chatbot applications by wiring together LangChain, vector databases, and hosted LLM APIs.",
        "Mostly worked with prompt templates, chains, and agents rather than production retrieval infrastructure.",
        "Used LangChain tutorials and existing components to assemble chatbot applications with limited backend ML work.",
        "Primary AI experience comes from integrating external LLM services instead of building production ML systems.",
    ],
